...
If you are not sure how something works be sure to read our [documentation](https://asraparadise.github.io/eightshift-docs/). If you found a bug in the code, please [open an issue](https://github.com/infinum/eightshift-docs/issues) and follow the instructions in the issue template.
